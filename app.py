...
def create_interactive_map(municipalities_gdf, counties_gdf, selected_counties, selected_tiers, selected_types, color_by):
    ...
    <div style="position: fixed; bottom: 50px; left: 50px; z-index: 1000; 
        ...
        <h4 style="margin: 0 0 10px 0; font-size: 14px;">Market Tiers</h4>
...
def main():
    ...
    # Header
    st.markdown('<p class="main-header">🎯 Hudson Valley Acupuncture Market Analysis</p>', unsafe_allow_html=True)
    st.markdown('<p class="sub-header">Interactive Dashboard • NYC to Albany Corridor • 10 Counties • 113 Municipalities</p>', unsafe_allow_html=True)
    st.markdown("---")
